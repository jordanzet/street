...
class UserProfile(models.Model):
	...
	timezone = models.CharField(_("time zone"), max_length=32, default='UTC-0500')
	image_profile = models.ImageField(blank=True, null=True, upload_to='userprofile/image/')
	...
	is_verified = models.BooleanField(_('verified'), default=False, help_text=_('Designates whether the user has verified his '
