...
def update(request):
	if request.method == 'POST':
		...
		formp = UserProfileForm(data=request.POST, instance=request.user.st)

		if all([uform.is_valid(), formp.is_valid()]):  # TODO: test!
			uform.save()
			formp.save()
		...
		formp = UserProfileForm(instance=request.user.st)
